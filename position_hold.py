...
class Edrone():
	...
	def __init__(self):
		...
		self.setpoint = [-8.394903182983398, 4.977997779846191, 27.915142059326172, 0.0] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
		...
		self.Kp = [11.5,10.4,24.0,11.20]
		self.Ki = [0,0,0,0]
		self.Kd = [47,48,320,42]	
