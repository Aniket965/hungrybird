function sysCall_init()
    ...
    no_of_goals = 1
    goals_handles = {}
    i_handle = sim.getObjectHandle('start')
    ...
    scale_factor = {4, 4, -17.32} -- Add the scale_factor you computed learned from the tutorial of whycon transformation
...
function packdata(path)
    ...
    for i=1,((no_of_path_points_required-1)*7)+1,7 do
        ...
        pose.position.z = (path[i+2])* scale_factor[3] + 35
