...
"""
    ...
    def key_callback(self, data):
        ...
        * Input: data (keydata)
        * Output: None
        * Logic: karm when data is 20(that is a is pressed), diarm when d pressed
    ...
    def pid(self):
        ...
        * Example Call: edrone.pid()
        ...
        errors = [dp - setp for dp,
                  setp in zip(self.drone_position, self.setpoint)]
